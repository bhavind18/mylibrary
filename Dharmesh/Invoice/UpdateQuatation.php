<?php
    ...
    $query = "SELECT * FROM tblbookmst WHERE QutationId='$q_id'";
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header" style="background-color: #2B60DE">
                        <center>
                            <h3 class="card-title" style="color: white">Invoice Id :
                                <?php echo $q_id ?>
                            </h3>
                        </center>
                    </div>
...
<!--                                     <th>Total</th> -->
                            ...
                            <tbody id="tbody">
                               ...
                               // $findItem = "SELECT Discription, Qty, Rate, Gst, GstAmount, Amount, QutationNo FROM tblbookdetails WHERE QutationId='$q_id'";
                               $findItem = "SELECT Discription, Qty, Rate, Gst, GstAmount, Amount, QutationNo FROM tblbookdetails, tblbookmst WHERE QutationId='$q_id'";
