<?php
    ...
    // Page header
        function Header()
        {
            ...
            $this->Image('./vidya mandir library.png',30,100,150);
            $this->Image('./book.png',8,8,50);
            
            $this->SetFont('Arial','B',15);
            $this->Cell(108 ,6,'',0,0);
            $this->SetFont('Arial','B',12);
            $this->Cell(80, 6, 'Address: Vidhya Mandir library,',0,1,'L');
            $this->Cell(128 ,6,'',0,0);
            $this->Cell(80 ,6,'Astha Complex,',0,1,'L');
            $this->Cell(128 ,6,'',0,0);
            $this->Cell(80 ,6,'150 ring road,',0,1,'L');
            $this->Cell(128 ,6,'',0,0);
            $this->Cell(80 ,6,'Ahmdabad.',0,1,'L');
            $this->Cell(110 ,6,'',0,0);
            $this->Cell(80 ,6,'Email Id: vidhyamandir.ahmdabad@gmail.com',0,1,'C');
            ...
            $this->SetFont('Times','B',12);
            $this->Cell(45,7, 'Invoice No   :','L', 0, 'L');
            $this->SetFont('Times','',12);
            ...
            $this->Cell(110, 6, 'Book Disc.', 1, 0, 'C');
        ...
        function Footer()
        {
            ...
            //$pdf->SetX(3);
            $this->Cell(190, 5, '1. you are the Responsible for Damages after the buying it', 0, 1, 'L');
            //$pdf->SetX(3);
            $this->Cell(190, 5, '2. take care of book like your part.', 0, 1, 'L');
            //$pdf->SetX(3);
            $this->Cell(190, 5, '3. Return books within 14 days.', 0, 1, 'L');
            //$pdf->SetX(3);
    ...
    $getMstDetails = "SELECT * FROM tblbookmst WHERE QutationId = {$qid}";
    //echo $getMstDetails;
    ...
    if($result_getMstDetails)
    {
        ...
        $pdf->AddPage();
        //$pdf->Output();
        $getDetails = "SELECT * FROM tblbookdetails WHERE QutationId = {$qid}";
