<?php
    ...
    $insertIntoQuotationMst =  "INSERT INTO tblbookmst (Name, QDate, TotalPrice, TotalGST, TotalAmount) VALUES ('".$name."', '{$date}', {$totalamount}, {$gstamount}, {$netamount})";
    ...
    if($result_insertIntoQuotationMst)
    {
        ...
        $insertIntoQuotationDetails = "INSERT INTO tblbookdetails (ItemNo, Discription, Qty, Rate, Gst, QutationId) VALUES ";
        for($i = 0; $i<$n; $i++)
        {
